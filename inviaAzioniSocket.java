 ...
 * @author Utente
 */
public class inviaAzioniSocket implements Serializable{
    ...
    public void serializzaAzioniXML(AzioniInGame azioni){
        ...
        try{
            Files.write(Paths.get("./myscenario/azioneSingola.xml"), x.getBytes());
        ...
        try{
            Files.write(Paths.get("./myscenario/azioni.xml"), y.getBytes());
           // y=new String(Files.readAllBytes(Paths.get("./myscenario/azioni.xml")));
